...
const Hero = () => {
  ...
  useGSAP(() => {
    ...
    tl.from(
      ...
      "-=0.4",
    ); // Starts 0.4 seconds before the previous animation ends
      ...
      <div className="bg-[#e4efff] relative px-4 md:px-10 md:py-8 overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 items-center gap-10 min-h-[80vh]">
          ...
          <div className="lefthero flex flex-col items-center md:items-start gap-8 order-2 md:order-1">
            ...
            {/* Search Box */}
            {/* <div className="leftelem w-[55vw] md:w-[40vw] max-w-3xl mx-auto md:mt-10">
              <div className="bg-white rounded-2xl md:rounded-full border-2 border-[#0ea5e9] p-3 md:p-4 flex flex-col md:flex-row items-center shadow-sm gap-3 md:gap-0">
                <div className="flex-[2] flex items-center px-3 md:px-4 gap-3 w-full md:w-auto">
                  <i className="ri-hospital-line text-[#002b5b] text-xl"></i>
                  <input
                    type="text"
                    placeholder="Search doctors, clinics, hospitals..."
                    className="w-full outline-none text-gray-500 placeholder-gray-400 text-sm md:text-base bg-transparent"
                  />
                </div>
                <button className="w-full md:w-auto mt-1 md:mt-0 bg-gradient-to-r from-primary to-secondary text-white px-8 py-3 rounded-full flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-md">
            ...
            <div className="leftelem w-[55vw] md:w-[40vw] max-w-3xl mx-auto md:mt-10">
              <div className="">
                ...
                <button className="w-full mt-1 md:mt-0 bg-gradient-to-r from-primary to-secondary text-white px-10 py-10 md:px-8 md:py-7 rounded-full flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-md">
                  <Link to='/booking' className="font-semibold text-lg text-nowrap md:text-xl tracking-wide">Take Appointment Now</Link>
                </button>
              </div>
            </div>
