...
const Doctors = () => {
  ...
  const docImg = [
    { id: 1, name: "Dr Ruby Perrin", img: "./doc1.webp", rating: "4.1", peoplecount: "20", fees: "200" },
    { id: 2, name: "Dr Darin Elder", img: "./doc2.webp", rating: "4.67", peoplecount: "12", fees: "120" },
    { id: 3, name: "Dr James Amen", img: "./doc3.webp", rating: "3.00", peoplecount: "3", fees: "130" },
    { id: 4, name: "Dr Saeed Tamer", img: "./doc4.jpg", rating: "3.5", peoplecount: "5", fees: "150" },
  ];

  const onMouseEnter = (e) => {
    const card = e.currentTarget;
    const img = card.querySelector(".doc-img");
    gsap.to(card, { y: -10, shadow: "0 20px 25px -5px rgb(0 0 0 / 0.1)", duration: 0.3 });
  ...
  const onMouseLeave = (e) => {
    const card = e.currentTarget;
    const img = card.querySelector(".doc-img");
    gsap.to(card, { y: 0, shadow: "0 4px 6px -1px rgb(0 0 0 / 0.1)", duration: 0.3 });
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-gray-400 text-sm">({item.peoplecount} Reviews)</span>
                  </div>
                  <button className="w-full mt-6 py-3 border-2 border-blue-600 text-blue-600 font-bold rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300">
                    View Profile
                  </button>
                </div>
              </div>
